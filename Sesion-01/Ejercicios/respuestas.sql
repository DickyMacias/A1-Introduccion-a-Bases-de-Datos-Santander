...
SELECT lastName, firstName, jobTitle, officeCode FROM employees WHERE officeCode = 1 && jobTitle = "Sales Rep";
...
-- 11. Dentro de la tabla employees, obtén el apellido, nombre y código de oficina de todos los empleados cuyo código de oficina sea menor o igual 4.
...
SELECT customerName, country, state FROM customers WHERE state = "CA" && country = "USA";
...
SELECT customerName, country, state, creditLimit FROM customers WHERE creditLimit > 100000 && state = "CA" && country = "USA";

-- 14. Dentro de la tabla customers, obtén el nombre y país de todos los clientes cuyo país sea USA o France.
SELECT customerName, country FROM customers WHERE country = "USA" || country = "France";
...
SELECT customerName, country, creditLimit FROM customers WHERE creditLimit > 100000 && (country = "USA" || country = "France");
...
SELECT officeCode, city, phone, country FROM offices WHERE country = "USA" || country = "France";
